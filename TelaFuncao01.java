 ...
 * @author cleci
 */
public class TelaFuncao01 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaFuncao01.class.getName());

    /**
     * Creates new form TelaFuncao01
     */
    public TelaFuncao01() {
        initComponents();
        setTitle("Fatorial");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int valor = Integer.parseInt(spnNumero.getValue().toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TelaFuncao01().setVisible(true));
    }
